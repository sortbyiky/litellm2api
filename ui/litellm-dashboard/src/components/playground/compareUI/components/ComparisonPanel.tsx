      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <Checkbox checked={comparison.applyAcrossModels} onChange={(e) => handleSyncChange(e.target.checked)}>
            <span className="text-xs font-medium">{t("playground.comparisonPanel.syncSettings")}</span>
          </Checkbox>
        </div>
        ...
        {/* General Settings */}
        <div>
          <h4 className="text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">{t("playground.comparisonPanel.generalSettings")}</h4>
          <div className="space-y-2">
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-0.5">{t("playground.comparisonPanel.tags")}</label>
              <TagSelector
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-0.5">{t("playground.comparisonPanel.vectorStores")}</label>
              <VectorStoreSelector
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-0.5">{t("playground.comparisonPanel.guardrails")}</label>
              <GuardrailSelector
        ...
        {/* Advanced Settings */}
        <div>
          <h4 className="text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">{t("playground.comparisonPanel.advancedSettings")}</h4>
          <div className="space-y-2">
            <div className="flex items-center gap-2 pb-1">
              ...
              >
                <span className="text-sm font-medium">{t("playground.comparisonPanel.useAdvancedParams")}</span>
              </Checkbox>
            </div>
            <div className="space-y-2 transition-opacity duration-200" style={{ opacity: disabledOpacity }}>
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className={`text-xs font-medium ${disabledTextColor}`}>{t("playground.comparisonPanel.temperature")}</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className={`text-xs font-medium ${disabledTextColor}`}>{t("playground.comparisonPanel.maxTokensLabel")}</label>
