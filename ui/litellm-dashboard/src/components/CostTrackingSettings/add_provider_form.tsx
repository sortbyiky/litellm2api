  ...
  return (
    <div className="space-y-6">
      <Form.Item
        label={
          <span className="text-sm font-medium text-gray-700 flex items-center">
            ...
            <Tooltip title={t("costTracking.selectProviderTooltip")}>
      ...
      >
        <AntdSelect
          showSearch
          placeholder={t("costTracking.selectProvider")}
      ...
      <Form.Item
        label={
          <span className="text-sm font-medium text-gray-700 flex items-center">
            {t("costTracking.discountPercentage")}
            <Tooltip title={t("costTracking.discountPercentageTooltip")}>
              <InfoCircleOutlined className="ml-2 text-blue-400 hover:text-blue-600 cursor-help" />
            </Tooltip>
          </span>
        }
        rules={[{ required: true, message: t("costTracking.pleaseEnterDiscount") }]}
      >
